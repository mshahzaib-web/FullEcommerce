...
const Footer = () => {
  const handleWhatsappBtn = () => {
    window.open("https://wa.me/923021547374", "_blank");
  };
    ...
    <footer className="bg-white border-t border-gray-100 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-gray-800 text-sm font-medium flex items-center gap-2 justify-center md:justify-start">
              <svg
        ...
        <div className="border-t border-gray-100 pt-6 flex justify-center gap-4">
          <p className="text-gray-400 text-xs">
            © 2026 LuxeAura Premium Fashion. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        <button
          ...
          className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition"
        >
