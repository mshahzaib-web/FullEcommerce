...
import { updateProductReview } from "../../api/User/user";
...
export default function AddReviewForm() {
  ...
  const { product, updateRating, updateComment } = location.state || {};

  useEffect(() => {
    setRating(updateRating);
    setHoverRating(updateRating);
    setReviewText(updateComment);
  }, [updateRating, updateComment]); // Or [] if these values don't change dynamically later
  ...
  const handleSubmit = (id) => {
    ...
    updateProductReviewMutation.mutate({ id, data: payload });
  };
